...
const displayCharacters = (characters) => {
    ...
    .map((character) => {
            return `
            <div id="tarjeta" style="background-image: url(imagenes/maestros/profile2.png)"> <a href = "#"></a><div class="texto_tarjeta">
            <div><h5><a href = "profile.php?id_teacher=${character.id_maestro}">${character.nombre_1} ${character.nombre_2}</a></h5><h5>${character.especialidad}</h5></div>
            <div class="abajo"><h5><img src="imagenes/estrellas/${character.valoracion}.png" alt=""></h5><h5>
